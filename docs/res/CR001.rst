...
#. Le présent projet a été baptisé AirLocksControl.
#. La demande pour des systèmes de contrôle d'accès de sites et de bâtiments encore plus sécurisés se développe pour des sites publics (stades, salles de concert) que privés (usines chimiques, laboratoires de biologie, centrales nucléaires). C'est une opportunité commerciale majeure pour les sociétés de sécurité comme AccessIT.
...
#. Différentes organisations ont déjà contacté AccessIT pour la mise en place de AirLocksControl.
...
#. Plusieurs universités indiennes voudraient également migrer vers AirLocksControl en 2023.
#. Les commerciaux de AccessIT prévoient une augmentation exponentielle des demandes au prochain trimestre.
#. Chaque version de AirLocksControl sera conçue et développée de façon incrémentale, en commençant par les fonctionnalités les plus demandées par les clients.
