...
#. Il s'agit donc d'un prospect chaud pour AirLocksControl.
...
#. Les autorisations sous forme de triplets pourraient aussi convenir a priori pour les autres sites gérés par AirLocksControl.
...
#. Avec AirLocksControl on estime que 4 gardiens seraient suffisants, d'où 12 en 3x8.
...
#. Un web service permettra à des systèmes externes (e.g. systèmes de paie / de contrôle de présence) d'importer les événements d'accès de AirLocksControl (horaire d'entrée pour chaque point d'accès).
...
#. AccesIT confirme son intérêt de développer une version d'AirLocksControl pour ce site.
